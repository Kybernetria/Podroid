...
Ticket #10 adds the separate strict v1 Host-supervisor desired-state record and durable lifecycle transaction outcomes behind `VmManager`. It exposes bounded read-only state locally but intentionally adds no reconciliation or boot receiver.
