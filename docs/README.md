...
Milestone 1 is documentation and additive scaffolding only. The existing `app/` module remains the logical Android application; none of the new source-area directories are Gradle modules yet.
